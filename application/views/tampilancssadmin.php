...
<div class="shell">
  ...
  <div id="header">
    ...
    <div id="navigation">
      <ul>
        <li><a href="http://localhost/Rekhas/index.php/cadmin/viewhomeadmin" >Home</a></li>
        <li><a href="http://localhost/Rekhas/index.php/cadmin/tampilsemuajersey">Lihat Jersey</a></li>
        <li><a href="http://localhost/Rekhas/index.php/cadmin/insertjersey">Tambah Jersey</a></li>
        <li><a href="http://localhost/Rekhas/index.php/cadmin/tampilpembayaran">Lihat Pembayaran</a></li>
        <li><a href="http://localhost/Rekhas/index.php/cadmin/logout">Logout</a></li>
      </ul>
    </div>
    <!-- End Navigation -->
  </div>
  ...
  <div id="main">
    ...
    <div id="content">
	  ...
	  <?php $data['error']='Silahkan login terlebih dahulu';?>
	  <?php $this->load->view('viewlogin',$data);?> 
	  <?php }else{ ?>
